                ...
                <div class="row">
                    <div class="col-md-5 col-sm-8  col-xs-12">
                        <div class="header-half header-call">
                            <p>
                                <span><i class="pe-7s-call"></i> 2250-0000</span>
                                <span><i class="pe-7s-mail"></i> your@remaxasdasdasdsa.com</span>
                            </p>
                        </div>
                    </div>
            ...
            <div class="slider-content">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-12">
                        <h2>Vende tu casa con los mejores</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eligendi deserunt deleniti, ullam commodi sit ipsam laboriosam velit adipisci quibusdam aliquam teneturo!</p>
                        <h2>Haz una cita</h>
                        <div class="search-form wow pulse" data-wow-delay="0.8s">
                            
                          
                            <form id="form-citas"  method="Post" class=" form-inline">
                                ...
                                <div class="form-group">
                                 ...
                                 <a><button type="submit" class="navbar-btn nav-button wow bounceInRight login" data-wow-delay="0.45s" onclick="validate_form()">Haz una cita </button></a> 
...
<script type="text/javascript">
    ...
    {
       if($('#nombre').val()==''||$('#apellido').val()==''||$('#email').val()==''||$('#Telefono').val()==''||$('fecha').val()=='')
       {
        alert('Todos los campos deben de ser llenados');
       }
        else
        {
            var url= "<?php echo site_url();?>/Welcome/add_cita";
            $.ajax({
                type:"POST",
                url:url,
                data: $("#form-citas").serialize(),
                success: function(data)
                {
                  ...
                  {
                    alert('Datos no han sido ingresados correctamente')
                  }  
                }
